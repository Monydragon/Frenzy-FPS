...
namespace Unity.FPS.AI
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<Armor, EnemyController>(m_Armor, this, gameObject);
        ...
        void OnDie()
        {
            ...
            {
                if (LootDrop[i].TryDropLoot())
                {
                    Instantiate(LootDrop[i].lootPrefab, transform.position, Quaternion.identity);
                }
            }
            //// loot an object
            //if (TryDropItem())
