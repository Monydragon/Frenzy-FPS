...
namespace Unity.FPS.Game
{
    ...
    public static class Events
    {
        ...
        public static EnemyAddedEvent EnemyAddedEvent = new EnemyAddedEvent();
        public static EnemyRemovedEvent EnemyRemovedEvent = new EnemyRemovedEvent();
    }
    ...
    public class EnemyAddedEvent : GameEvent
    {
        public int Amount;
        public GameObject Enemy;
    }
    public class EnemyRemovedEvent : GameEvent
    {
        public int Amount;
        public GameObject Enemy;
    }
